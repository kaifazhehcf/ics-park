...
import { getPolicyList, delPolicy, changMarketable } from '@/api/business/policy'
...
export default {
  ...
  data () {
    return {
      ...
      selectedRowKeys: [],
      selectedRows: [],
      addEnable: checkPermission('business:policy:add'),
      editEnabel: checkPermission('business:policy:edit'),
      removeEnable: checkPermission('business:policy:remove')
    }
  },
  filters: {
  },
