...
import { getDjList, delDj, changMarketable } from '@/api/business/dj'
...
export default {
  ...
  data () {
    return {
      ...
      selectedRowKeys: [],
      selectedRows: [],
      addEnable: checkPermission('business:dj:add'),
      editEnabel: checkPermission('business:dj:edit'),
      removeEnable: checkPermission('business:dj:remove')
    }
  },
  filters: {
  },
