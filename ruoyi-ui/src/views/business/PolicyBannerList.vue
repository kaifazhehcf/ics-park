...
import { getPolicyBannerList, delPolicyBanner, changMarketable } from '@/api/business/policyBanner'
...
export default {
  ...
  data () {
    return {
      ...
      selectedRowKeys: [],
      selectedRows: [],
      addEnable: checkPermission('business:policyBanner:add'),
      editEnabel: checkPermission('business:policyBanner:edit'),
      removeEnable: checkPermission('business:policyBanner:remove')
    }
  },
  filters: {
  },
